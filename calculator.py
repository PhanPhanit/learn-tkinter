...
button_add = Button(root, text="+", padx=39, pady=20, command=lambda: add_click())
button_equal = Button(root, text="=", padx=91, pady=20, command=lambda: button_equal_click())
button_clear = Button(root, text="Clear", padx=79, pady=20, command=lambda: clear_txt())
